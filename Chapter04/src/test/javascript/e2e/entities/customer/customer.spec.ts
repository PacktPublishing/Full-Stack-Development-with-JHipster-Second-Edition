  ...
  it('should create and save Customers', async () => {
    ...
    await promise.all([
      ...
      customerUpdatePage.setEmailInput(
        'ZA]D^w1j!($K^b_W$R,|s{&gt;q-#[;k%{2=&gt;skQk@)pGu);K|X~bw([2~R&#34;[G$U&#34;LM_TZjOISvD|NA/SoPhg&amp;&gt;zQ{/C%cq4rr~&#39;4.A2v&amp;|+=X&lt;;Bp/gb=.GUtF#,H&#34;~=(9Y3fwElbA3d5os%-Q'
      ),
    ...
    expect(await customerUpdatePage.getEmailInput()).to.eq(
      'ZA]D^w1j!($K^b_W$R,|s{&gt;q-#[;k%{2=&gt;skQk@)pGu);K|X~bw([2~R&#34;[G$U&#34;LM_TZjOISvD|NA/SoPhg&amp;&gt;zQ{/C%cq4rr~&#39;4.A2v&amp;|+=X&lt;;Bp/gb=.GUtF#,H&#34;~=(9Y3fwElbA3d5os%-Q',
      'Expected Email value to be equals to ZA]D^w1j!($K^b_W$R,|s{&gt;q-#[;k%{2=&gt;skQk@)pGu);K|X~bw([2~R&#34;[G$U&#34;LM_TZjOISvD|NA/SoPhg&amp;&gt;zQ{/C%cq4rr~&#39;4.A2v&amp;|+=X&lt;;Bp/gb=.GUtF#,H&#34;~=(9Y3fwElbA3d5os%-Q'
    );
